...
const Torus: React.FC<ProjectModelTypes> = ({ visible, isAnimating }) => {
	const modelRef = useModelRotation(isAnimating);
	...
	return (
		<mesh visible={visible || isAnimating} ref={modelRef}>
			<torusGeometry args={[1.4, 0.4, 16, 100]} />
